...
SWEP.Description = "Giant anti-materiel rifle. Will punch a hole through just about anything."
...
SWEP.Range_Min = 1280 // distance for which to maintain maximum damage
...
SWEP.AttachmentElements = {
    ["optic"] = {
		...
		Mult_HipFireSpreadPenalty = 0.45,
