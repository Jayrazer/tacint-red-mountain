...
SWEP.Description = "Burst fire bullpup with low damage but tight spread."
...
SWEP.Range_Min = 1075 // distance for which to maintain maximum damage
...
SWEP.MidAirSpreadPenalty = 0.085 // spread penalty for being in the air
...
SWEP.RecoilDissipationRate = 120
SWEP.RecoilFirstShotMult = 1 // multiplier for the first shot's recoil amount

SWEP.RecoilVisualKick = 0.10
...
local path = "tacint_extras/famas/"

SWEP.Sound_Shoot = "^" .. path .. "famas-1.wav"
SWEP.Sound_Shoot_Silenced = "tacint/weapons/k1a/fire_silenced-1.wav"
...
SWEP.Attachments = {
    ...
    [2] = {
        ...
        Pos_VM = Vector(-3.1, 0, 21.4),
        Pos_WM = Vector(24, 1, -4.5),
        Ang_VM = Angle(90, 0, 0),
        Ang_WM = Angle(0, 0, 0),
    },
    [3] = {
        ...
        Pos_VM = Vector(-5.2, -0.6, 11.8),
        Pos_WM = Vector(15.5, 1.7, -6),
...
addsound("tacint_famas.insert_clip", path .. "Clipout.wav")
addsound("tacint_famas.remove_clip", path .. "Clipin.wav")
