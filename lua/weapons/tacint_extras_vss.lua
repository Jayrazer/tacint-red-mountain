...
SWEP.AttachmentElements = {
    ...
    ["irons"] = {
        ...
        Mult_HipFireSpreadPenalty = 0.1,
        Mult_CrouchSpreadPenalty = -0.025,
        Mult_MoveSpreadPenalty = 1.5,
    },
	["fcg"] = {
		Mult_RecoilSpreadPenalty = 0.25,
		Override_RPM = 700,
	},
}
