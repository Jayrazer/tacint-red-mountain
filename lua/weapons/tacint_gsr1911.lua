...
SWEP.Description = "Big pistol that hits hard up close but is limited by its low magazine capacity."
...
SWEP.Range_Max = 930 // distance at which we drop to minimum damage
