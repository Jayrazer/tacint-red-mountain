...
SWEP.Description = "Well-balanced assault rifle. \nA staple of the modern battlefield."
...
SWEP.Range_Min = 1340 // distance for which to maintain maximum damage
