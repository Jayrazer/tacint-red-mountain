...
SWEP.Description = "Semi-automatic shotgun. \nThere's nothing seven rounds of buckshot can't solve."
...
SWEP.HipFireSpreadPenalty = 0.12 // spread penalty for not being scoped in
SWEP.BlindFireSpreadPenalty = 0.05 // spread penalty for blind firing
SWEP.CrouchSpreadPenalty = 0
SWEP.ScopedSpreadPenalty = 0.06
