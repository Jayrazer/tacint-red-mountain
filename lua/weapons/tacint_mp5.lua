...
SWEP.Description = "Well-balanced SMG. The go-to weapon for counter-terrorism operations."
...
SWEP.HipFireSpreadPenalty = 0.038 // spread penalty for not being scoped in
SWEP.ScopedSpreadPenalty = 0.023
