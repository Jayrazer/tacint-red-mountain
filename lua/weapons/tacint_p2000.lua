...
SWEP.Description = "Pistol with balanced characteristics."
...
SWEP.Range_Min = 645 // distance for which to maintain maximum damage
SWEP.Range_Max = 1270 // distance at which we drop to minimum damage
...
SWEP.MoveSpreadPenalty = 0.005 // spread penalty while travelling at max. 250 u/s
SWEP.MidAirSpreadPenalty = 0.025 // spread penalty for being in the air
