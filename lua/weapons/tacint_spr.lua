...
SWEP.Description = "Hunting rifle-turned-military sniper with a fast cycle speed."
...
SWEP.Damage_Min = 67 // damage at maximum range
SWEP.Range_Min = 875 // distance for which to maintain maximum damage
