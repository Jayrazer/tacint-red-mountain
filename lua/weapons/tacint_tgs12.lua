...
SWEP.MoveSpreadPenalty = 0.11 // spread penalty while travelling at max. 250 u/s
SWEP.MidAirSpreadPenalty = 0.14 // spread penalty for being in the air
SWEP.HipFireSpreadPenalty = 0.165 // spread penalty for not being scoped in
SWEP.BlindFireSpreadPenalty = 0.05 // spread penalty for blind firing
SWEP.CrouchSpreadPenalty = 0
SWEP.ScopedSpreadPenalty = 0.09
...
local path = "tacint/weapons/tgs12/"
...
addsound("tacint_Bekas.Insertshell", "tacint/weapons/bekas/insertshell-1.wav")
