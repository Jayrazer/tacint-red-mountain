...
SWEP.Description = "Lightweight bolt action sniper rifle with fantastic long range performance."
...
SWEP.Damage_Max = 32 // damage at minimum range
SWEP.Damage_Min = 100 / 2 // damage at maximum range
SWEP.Range_Min = 800 // distance for which to maintain maximum damage
SWEP.Range_Max = 1575 // distance at which we drop to minimum damage
...
SWEP.AttachmentElements = {
    ...
    ["optic"] = {
		...
		Mult_HipFireSpreadPenalty = 0.44,
