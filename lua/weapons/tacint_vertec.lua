...
// names and stuff
SWEP.PrintName = "M9 Vertec"
SWEP.Category = "Tactical Intervention"

SWEP.Description = "All-rounder handgun with a high-capacity magazine."
...
SWEP.Range_Max = 1180 // distance at which we drop to minimum damage
...
SWEP.MoveSpreadPenalty = 0.015 // spread penalty while travelling at max. 250 u/s
SWEP.MidAirSpreadPenalty = 0.030 // spread penalty for being in the air
...
local path = "tacint/weapons/vertec/vertec_"
