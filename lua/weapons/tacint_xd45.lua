...
// names and stuff
SWEP.PrintName = "XD-45 Auto"
SWEP.Category = "Tactical Intervention"

SWEP.Description = "Fully-automatic machine pistol with close range stopping power."
...
SWEP.Range_Max = 650 // distance at which we drop to minimum damage
...
SWEP.HipFireSpreadPenalty = 0.07 // spread penalty for not being scoped in
...
local path = "tacint/weapons/xd45/"

SWEP.Sound_Shoot = "^" .. path .. "fire-1.wav"
SWEP.Sound_Shoot_Silenced = "tacint/weapons/vertec/vertec_fire_silenced-1.wav"
